...
import g1 from '../components/Images/g1.jpg.webp'
import g2 from '../components/Images/g2.jpg.webp'
import g3 from '../components/Images/g3.jpg.webp'
import g4 from '../components/Images/g4.jpg.webp'
import g5 from '../components/Images/g5.jpg.webp'
import g6 from '../components/Images/g6.jpg.webp'
import g7 from '../components/Images/g7.jpg.webp'
import g8 from '../components/Images/g8.jpg.webp'




const ElementsP = () => {
  // const [hide, unhide] = useState()
  return (
    <div>
      ...
      <section className="button-area">
        <div className="container block2_section border-top-generic">
      ...
      <div className="whole-wrap">
        <div className="container block2_section">
          <div className="section-top-border">
            <h3 className="mb-30">Left Aligned</h3>
            <div className="row">
              <div className="col-md-3">
                <img
                  data-cfsrc="img/elements/d.jpg"
                  alt=""
                  className="img-fluid"
                  src="https://preview.colorlib.com/theme/proshoot/img/elements/d.jpg"
                />
              </div>
              ...
              <div className="progress-table">
                ...
                <div className="table-row">
                  ...
                  <div className="country">
                    {" "}
                    <img
                      data-cfsrc="img/elements/f1.jpg"
                      alt="flag"
                      src="https://preview.colorlib.com/theme/proshoot/img/elements/f1.jpg"
                    />
                    Canada
                  </div>
                ...
                <div className="table-row">
                  ...
                  <div className="country">
                    {" "}
                    <img
                      data-cfsrc="img/elements/f2.jpg"
                      alt="flag"
                      src="https://preview.colorlib.com/theme/proshoot/img/elements/f2.jpg"
                    />
                    Canada
                  </div>
                  <div className="visit">645032</div>
                ...
                <div className="table-row">
                  ...
                  <div className="country">
                    {" "}
                    <img
                      data-cfsrc="img/elements/f3.jpg"
                      alt="flag"
                      src="https://preview.colorlib.com/theme/proshoot/img/elements/f3.jpg"
                    />
                    Canada
                  </div>
                  <div className="visit">645032</div>
                ...
                <div className="table-row">
                  ...
                  <div className="country">
                    {" "}
                    <img
                      data-cfsrc="img/elements/f4.jpg"
                      alt="flag"
                      src="https://preview.colorlib.com/theme/proshoot/img/elements/f4.jpg"
                    />
                    Canada
                  </div>
                  <div className="visit">645032</div>
                ...
                <div className="table-row">
                  ...
                  <div className="country">
                    {" "}
                    <img
                      data-cfsrc="img/elements/f5.jpg"
                      alt="flag"
                      src="https://preview.colorlib.com/theme/proshoot/img/elements/f5.jpg"
                    />
                    Canada
                  </div>
                  <div className="visit">645032</div>
                ...
                <div className="table-row">
                  ...
                  <div className="country">
                    {" "}
                    <img
                      data-cfsrc="img/elements/f6.jpg"
                      alt="flag"
                      src="https://preview.colorlib.com/theme/proshoot/img/elements/f6.jpg"
                    />
                    Canada
                  </div>
                  <div className="visit">645032</div>
                ...
                <div className="table-row">
                  ...
                  <div className="country">
                    {" "}
                    <img
                      data-cfsrc="img/elements/f7.jpg"
                      alt="flag"
                      src="https://preview.colorlib.com/theme/proshoot/img/elements/f7.jpg"
                    />
                    Canada
                  </div>
                  <div className="visit">645032</div>
                ...
                <div className="table-row">
                  ...
                  <div className="country">
                    {" "}
                    <img
                      data-cfsrc="img/elements/f8.jpg"
                      alt="flag"
                      src="https://preview.colorlib.com/theme/proshoot/img/elements/f8.jpg"
                    />
                    Canada
                  </div>
                  <div className="visit">645032</div>
            ...
            <div className="row">
              <div className="col-lg-8 col-md-8">
                ...
                <form action="#">
                  ...
                  <div className="input-group-icon mt-10">
                    <div className="icon">
                      <i className="ti-location-arrow" aria-hidden="true" />
                    </div>
